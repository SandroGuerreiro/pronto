...
vi.mock("../state", () => ({
  ...
  get ignoredLabels() { return mockState.ignoredLabels; },
  get requestsLabelHintDismissed() { return mockState.requestsLabelHintDismissed; },
  ...
  setIgnoredLabels: (labels: string[]) => mockState.setIgnoredLabels(labels),
  setRequestsLabelHintDismissed: (v: boolean) => mockState.setRequestsLabelHintDismissed(v),

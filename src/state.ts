...
export let ignoredLabels: string[] = [];
export let requestsLabelHintDismissed: boolean = false;
...
export function setIgnoredLabels(labels: string[]) { ignoredLabels = labels; }
export function setRequestsLabelHintDismissed(v: boolean) { requestsLabelHintDismissed = v; }
